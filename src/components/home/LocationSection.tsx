    ...
    <div className="absolute left-0 top-[6831px] w-full flex flex-col items-center pb-16 font-[family-name:var(--font-poppins)]">
      ...
      <div className="relative w-[1320px] h-[640px]">
        ...
        <div className="absolute left-0 top-0 w-[950px] h-[640px] shadow-sm bg-gray-50 relative overflow-hidden">
          ...
          <div className="absolute left-[calc(50%-35px)] top-[calc(50%-78px)] pointer-events-none z-20 flex flex-col items-center">
            <div className="relative w-[60px] h-[80px]">
              <svg viewBox="-4 -4 68 88" className="absolute -left-[4px] -top-[4px] w-[68px] h-[88px] drop-shadow-xl">
                <path 
              ...
              <div className="absolute left-[1px] top-[1px] w-[58px] h-[58px] bg-white rounded-full flex items-center justify-center shadow-inner z-10">
                <img src="/images/home/logo.svg" alt="Dental Esthetique Pin" className="w-[85%] h-[85%] object-contain" />
              </div>
            </div>
            {/* Pin Shadow */}
        ...
        <div className="absolute right-0 top-[60px] w-[380px] h-auto min-h-[440px] bg-[#135CB2] flex flex-col pt-8 pb-8 px-8 shadow-[0_15px_50px_rgba(0,0,0,0.15)] z-10 text-white font-[family-name:var(--font-poppins)]">
          ...
          <div className="flex flex-col mb-5">
            {[
              { day: 'Monday', time: '8AM-9PM', showBook: true },
              { day: 'Tuesday', time: '8AM-9PM', showBook: true },
              { day: 'Wednesday', time: '9AM-6:30PM', showBook: true },
              { day: 'Thursday', time: '8AM-9PM', showBook: true },
              { day: 'Friday', time: '8AM-9PM', showBook: true },
              { day: 'Sat-Sun', time: 'Closed', showBook: false },
            ].map((item, index) => (
              <div key={index} className="flex items-center justify-between py-[7px] border-b border-white/20 text-[12px]">
                ...
                {item.showBook ? (
                  ...
                  <div className="w-[58px]"></div> // Placeholder for alignment
                )}
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-col gap-2 mt-auto">
            ...
            <button className="flex h-[36px] w-max items-center justify-center gap-1.5 rounded bg-white px-4 font-[family-name:var(--font-poppins)] text-[11px] font-semibold text-[#C187A4] hover:bg-gray-50 transition-colors group shadow-sm">
              Suggest Checkup Time 
              <ChevronRight size={12} className="text-[#C187A4]/70 group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
        </div>
      </div>
