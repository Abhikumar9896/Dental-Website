...
export default function BookAppointment() {
  return (
    <div className="absolute left-[60px] top-[866px] w-[1320px] h-[640px] z-30">
      <motion.div
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col gap-5 w-[320px]">
            <input
              ...
              className="w-full h-[52px] border border-gray-200/80 rounded-md px-4 font-poppins text-[14px] text-gray-500 outline-none focus:border-[#165ba7] transition-colors"
            />

            <div className="relative">
              <select className="w-full h-[52px] border border-gray-200/80 rounded-md px-4 font-poppins text-[14px] text-[#333] font-medium outline-none appearance-none focus:border-[#165ba7] transition-colors bg-white cursor-pointer">
            ...
            <textarea
              ...
              className="w-full h-[80px] border border-gray-200/80 rounded-md px-4 py-3 font-poppins text-[14px] text-gray-500 outline-none focus:border-[#165ba7] transition-colors resize-none"
            ></textarea>

            <button className="group flex w-full h-[54px] items-center justify-center gap-2 rounded-md bg-[#A66689] hover:bg-[#8F5675] transition-colors shadow-sm text-white font-poppins text-[15px] font-medium mt-1">
              Book Your Dentist
              <svg
